# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-07-04 06:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ads.AdPlace', verbose_name='Ad Place')),
                ('section', models.ManyToManyField(to='ads.AdSection', verbose_name='Section')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
