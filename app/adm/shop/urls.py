...
from app.models import ProductCategory as Model
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<children_url>sections)/(?P<category>\d+)/', include('app.adm.shop.sections.urls', namespace='product_sections')),
)